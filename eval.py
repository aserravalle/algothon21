...
import numpy as np
import pandas as pd
from JH4 import getMyPosition as getPosition
...
def calcPL(prcHist):
    ...
    for t in range(201,251):
        ...
        print ("Day %d | value: %.2lf | todayPL: $%.2lf | $-traded: %.0lf | return: %.5lf | frac0: %.4lf | frac1: %.4lf | comms: %.4lf" % (t,value, todayPL, totDVolume, ret, frac0, frac1, comm))
